 ...
 */
final class Version20250214150038 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE film_category (category_id INT NOT NULL, film_id INT NOT NULL, INDEX IDX_A4CBD6A812469DE2 (category_id), INDEX IDX_A4CBD6A8567F5183 (film_id), PRIMARY KEY(category_id, film_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
